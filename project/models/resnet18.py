...
from project.models.binarylib import AdaBin_Conv2d, Maxout
...
def resnet18_encoder(in_channels: int):
    encoder = resnet18_1w1a()
    encoder.conv1 = nn.Conv2d(in_channels, 64, kernel_size=3, stride=1, padding=1, bias=False)
